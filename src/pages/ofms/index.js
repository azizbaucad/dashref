...
import { StackedBarChart } from '@components/common/charts/stackedbarcharts';
import { LineCharts } from '@components/common/charts/linecharts';

export default function OfmsPage() {
      ...
      <Flex mt={6} px={2} w={'100%'} mb={3}>
        <Box>
          <PageTitle
            ...
            title={'OFMS'}
            subtitle={' / Orange Finance Mobile Sénégal'}
          />
        </Box>
        <Spacer />
        <Box mr={1}>
      ...
      <Stack w={'100%'} p={3}>
        ...
        >
          ...
          >
            ...
            <Box>
              <TagTitle title={'Parc Actfis'} size={14} />
            </Box>
            <Divider mt={2} />
            <Box>
              <ValuesData />
          ...
          >
            ...
            {/* Content for Répartition (en %) */}
            <Box>
              <TagTitle title={'Transactions'} size={14} />
            </Box>
            <Divider mt={2} />
            <Box>
              <ValuesData />
